...
class StaticObstacle(Obstacle):
    ...
    def set_collision_avoidance_constraints(self, prediction_horizon, ego_vehicle_diameter, state_X):
        ...
        # Setting up the collision constraints according to : sqrt((x_robot - x_obstacle)^2 + (y_robot - y_obstacle)^2) >= robot_radius + obstacle_radius
    ...
    def get_obstacle_type(self):
        return self.obstacle_type.static_obstacle
