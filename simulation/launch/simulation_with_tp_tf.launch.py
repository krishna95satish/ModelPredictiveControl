...
def generate_launch_description():
    trajectory_planning_pkg_prefix = get_package_share_directory('trajectory_planning')
    trajectory_following_pkg_prefix = get_package_share_directory('trajectory_following')
    ...
    trajectory_planning_node = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(trajectory_planning_pkg_prefix, 'trajectory_planning.launch.py')))

    trajectory_following_node = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(trajectory_following_pkg_prefix, 'trajectory_following.launch.py')))
