...
try:
    sys.path.append(glob.glob('/home/krishna/CARLA_SIM/PythonAPI/carla/dist/carla-0.9.11-py3.7-linux-x86_64.egg')[0])
except IndexError:
    pass
...
def main(args=None):
    ...
    parameters['timeout'] = carla_bridge.get_param('timeout', 200)
    ...
    try:
        ...
        print("The version is : " + dist.version)
